...
func (*observations) Observe(t time.Time, speed float64, gust float64, b float64) {
	o.observation = append(o.observation, observation{timestamp: t, windSpeed: speed, windGust: gust, bearing: b})
}
